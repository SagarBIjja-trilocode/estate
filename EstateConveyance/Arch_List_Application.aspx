<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Architect.Master"  CodeBehind="Arch_List_Application.aspx.cs" Inherits="EstateConveyance.Arch_List_Application" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row card" style="width:100%; margin-left:10px; padding:15px; top: 1px; left: 0px;">
      <center> <h2 style="color:#ff8d00;">Application for Renewal of Lease Agreement</h2><hr></center>
        <div class="form-row ">
          ...
          <tbody>
            ...
            <tr style="font-size:14px;">
              ...
              <td width ="25%">
                  ...
                  |<a href="Arch_Scrutiny_Remark.aspx" style="color:blue"> Scrutiny & Remark</a> | <br />
