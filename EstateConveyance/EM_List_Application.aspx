        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td>Pending @ Jt CO</td>
                    <td width="40%">
                        |<a href="Images/Application of Society will show on pdf.pdf" style="color: blue"> View Application</a>| 
                        |<a href="EE_Society_Documents.aspx" style="color: blue"> Society Document</a>|
                        <br />
                        |<a href="EE_Forward_Application.aspx" style="color: blue"> Forward Application</a>|
                        <br />
                        |<a href="EM_Conveyance_Certificate.aspx" style="color: blue"> Conveyance Certificates </a>|
                        <br />
                        |<a href="EM_Tenments_Calculation.aspx" style="color: blue">Tenement Calculations</a>|
                        <br />
                        |<a href="EM_Payment_Details.aspx" style="color: blue">Payment Details</a>| 
                        |<a href="EM_View_Rates.aspx" style="color: blue"> View Rates</a>| 
                        <br />
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td>Address</td>
                    <td>Pending @ LA</td>
                    <td width="40%">|<a href="Images/Application of Society will show on pdf.pdf" style="color: blue"> View Application</a>| 
                  |<a href="EE_Society_Documents.aspx" style="color: blue"> Society Document</a>|
                        <br />
                        |<a href="EE_Forward_Application.aspx" style="color: blue"> Forward Application</a>|
                        <br />
                        |<a href="EE_Calculation_Sheet.aspx" style="color: blue"> Conveyance Certificates </a>|
                        <br />
                        |<a href="EE_Define_Rates.aspx" style="color: blue">Tenement Calculations</a>|
                        <br />
                        |<a href="EE_Define_Rates.aspx" style="color: blue">Payment Details</a>| 
                  |<a href="EE_Forward_Application.aspx" style="color: blue"> View Rates</a>| 
                        <br />
