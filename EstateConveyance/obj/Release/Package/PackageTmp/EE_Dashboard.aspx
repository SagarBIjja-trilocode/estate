<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="EE.Master" CodeBehind="EE_Dashboard.aspx.cs" Inherits="EstateConveyance.EE_Dashboard" %>
        ...
        <br />
          ...
          <thead>
            <tr style="background-color:#1a73e8;">
              <th scope="col" style="color:white">Total No of Application</th>
               <th scope="col" style="color:white">Application Pending </th>
               <th scope="col" style="color:white">Process completed & Forwarded to EM</th>
                <th scope="col" style="color:white">Forwarded to EM for queries</th>
          ...
          <h5 style="color:red">Redevelopment Application</h5>
          ...
          <thead>
            <tr style="background-color:#1a73e8;">
              ...
              <th scope="col" style="color:white">Application Sent for Compliance</th>
                <th scope="col" style="color:white">Application Forwarded to DyCE</th>
