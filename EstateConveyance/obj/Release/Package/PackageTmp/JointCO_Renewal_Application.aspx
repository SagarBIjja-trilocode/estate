<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="Joint_CO.Master" CodeBehind="JointCO_Renewal_Application.aspx.cs" Inherits="EstateConveyance.JointCO_Renewal_Application" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row card" style="width:100%; margin-left:10px; padding:15px; top: 1px; left: 0px;">
      <center> <h2 style="color:#ff8d00;">Application for Society Renewal</h2><hr></center>
        <div class="form-row ">
          ...
          <tbody>
            ...
            <tr style="font-size:14px;">
              ...
              <td width ="25%">
                  ...
                  |<a href="DyCO_Formation_Scrutiny.aspx" style="color:blue"> EE Scrutiny & Remarks</a> | <br /> 
                  |<a href="DyCO_Formation_Scrutiny.aspx" style="color:blue"> Architect Scrutiny</a> | <br /> 
                  |<a href="DyCO_Formation_Scrutiny.aspx" style="color:blue"> Forward Application</a> | <br />
                  |<a href="DyCO_Formation_Forward_Application.aspx" style="color:blue"> Renewed lease deed Agreement</a> |<br />
              </td>
            </tr>
