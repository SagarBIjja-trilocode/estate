<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Architect.Master" CodeBehind="Arch_Renewal_Application.aspx.cs" Inherits="EstateConveyance.Arch_Renewal_Application" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form class="needs-validation" novalidate>
        ...
        <div class="row card" style="width: 100%; margin-left: 10px; padding: 15px; top: 1px; left: 0px;">
            <center>
                <h2 style="color: #ff8d00;">Application for Renewal Lease Agreement</h2>
                <hr>
            </center>
            <div class="form-row ">
            ...
            <tbody>
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td width="40%">
                        ...
                        |<a href="EE_Formation_Society_Documents.aspx" style="color: blue"> Society Document</a>|
                        <br />
                        |<a href="EE_Renewal_Scrutiny.aspx" style="color: blue"> EE Scrutiny & Remarks</a>|
                        <br />
                        |<a href="EE_Renewal_Forward_Application.aspx" style="color: blue">Forward Application</a>|
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td>Pending @ LA</td>
                     <td width="40%">
                        ...
                        |<a href="EE_Formation_Society_Documents.aspx" style="color: blue"> Society Document</a>|
                        <br />
                        |<a href="EE_Renewal_Scrutiny.aspx" style="color: blue"> Scrutiny & Remarks</a>|
                        <br />
                        |<a href="EE_Renewal_Forward_Application.aspx" style="color: blue">Approved List Of Tenements</a>|
