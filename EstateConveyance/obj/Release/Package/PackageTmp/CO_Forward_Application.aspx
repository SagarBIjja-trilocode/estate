<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="CO.Master" CodeBehind="CO_Forward_Application.aspx.cs" Inherits="EstateConveyance.CO_Forward_Application" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <br>
    <div class="row card" style="width:100%; margin-left:10px; padding:15px;">
       <center> <h3 style="color:#ff8d00;">Forward Application</h3><hr></center>
         <div class="col-md-4 mb-3">
        <input type=button value="Go back" onclick='history.go(-1)' class="btn btn-success" >
            </div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home" data-toggle="tab" href="#Scrutiny" role="tab" aria-controls="Scrutiny"
                  aria-selected="true">Scrutiny History</a>
              </li>

             <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#forward_application" role="tab" aria-controls="Scrutiny"
      ...
      <center><button class="btn btn-success" type="submit" style="width:200px;">Forward Remark</button></center>
     </div>

     
  
               <div class="tab-pane fade show active" id="forward_application" role="tabpanel" aria-labelledby="home-tab"> 
              <br />  
                <h5>Remark </h5>
