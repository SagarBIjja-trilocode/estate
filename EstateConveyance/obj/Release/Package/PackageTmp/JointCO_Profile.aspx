<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Joint_CO.Master" CodeBehind="JointCO_Profile.aspx.cs" Inherits="EstateConveyance.JointCO_Profile" %>
...
<form class="needs-validation" novalidate>
    ...
    <div class="row card" style="width:100%; margin-left:10px; padding:15px; top: 1px; left: 0px;">
      <center> <h2 style="color:#ff8d00;"> JointCO Profile</h2><hr></center>
        <div class="form-row ">
