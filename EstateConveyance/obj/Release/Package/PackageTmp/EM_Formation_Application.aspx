<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="EM.Master" CodeBehind="EM_Formation_Application.aspx.cs" Inherits="EstateConveyance.EM_Formation_Application" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form class="needs-validation" novalidate>
        ...
        <div class="row card" style="width: 100%; margin-left: 10px; padding: 15px; top: 1px; left: 0px;">
            <center>
                <h2 style="color: #ff8d00;">Application for Society Formation</h2>
                <hr>
            </center>
            <div class="form-row ">
            ...
            <tbody>
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td width="40%">
                        ...
                        <br />
                        |<a href="EM_Formation_Scrutiny.aspx" style="color: blue"> Scrutiny & Remarks</a>|
                        <br />
                        |<a href="EM_Approved_List_Tenements.aspx" style="color: blue">Approved List Of Tenements</a>|
