...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row card" style="width:100%; margin-left:10px; padding:15px; top: 1px; left: 0px;">
      <center> <h2 style="color:#ff8d00;">NOC For Conveyance</h2><hr></center>
        <div class="form-row ">
        ...
        <input type=button class="btn btn-success" value="Go back" onclick='history.go(-1)'  >
            </div>
    ...
    <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size:14px;">
              ...
              <td>Pending @ Jt CO</td> 
              <td>
                  <a href="Images/Application of Society will show on pdf.pdf" ><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; Download</a> <br />
                  <a href="#"><i class="fa fa-send"></i>&nbsp; Send To Society</a> 
              </td>
            </tr>
