<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/EM.Master" CodeBehind="EM_Dashboard.aspx.cs" Inherits="EstateConveyance.EM_Dashboard" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


      <div class="jumbotron" style="background-color:#fff;">
        <center>  <h2>Application for Society </h2> </center> <br>

    <h5 style="color:red">Application for Society Formation</h5>
        ...
        <br />
            ...
            <tr style="background-color:#1a73e8;">
              <th scope="col" style="color:white">Total No of Application</th>
               ...
               <th scope="col" style="color:white">Process Completed & Forwarded to DyCO</th>
                <th scope="col" style="color:white">Application forwarded to Subordinate</th>
          ...
          <br />
           <h5 style="color:red">Renewal of Post Lease Deed Agreement</h5>
           <table class="table table-bordered">
          <thead>
            <tr style="background-color:#1a73e8;">
              <th scope="col" style="color:white">Total No of Application</th>
