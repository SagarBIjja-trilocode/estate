<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="LA.Master" CodeBehind="LA_List_Application.aspx.cs" Inherits="EstateConveyance.LA_List_Application" %>
          ...
          <tbody>
            ...
            <tr style="font-size:14px;">
              ...
              <td width ="25%">
                  ...
                  |<a href="LA_Forward_Application.aspx" style="color:blue"> Forward Application</a> |  
                  ...
                  |<a href="CO_Approve_SaleDeed.aspx" style="color:blue"> Deed Agreement </a> | 
              ...
              <td>Pending @ LA</td>
               <td width ="25%">
                  |<a href="Images/Application of Society will show on pdf.pdf" style="color:blue"> View Application</a> | <br />
                  |<a href="DyCo_Society_Documents.aspx" style="color:blue"> Society Document</a> | <br />
                  |<a href="LA_Forward_Application.aspx" style="color:blue"> Forward Application</a> |   <br />
                  |<a href="DyCO_EE_Documents.aspx" style="color:blue"> EE Document</a> | <br />
                  |<a href="DyCO_EM_Documents.aspx" style="color:blue"> EM Document</a> | <br />
                  |<a href="CO_Approve_SaleDeed.aspx" style="color:blue"> Deed Agreement </a> | <br />
                  |<a href="CO_Checklist_Note.aspx" style="color:blue"> Checklist & Office Note</a> | <br /> 
