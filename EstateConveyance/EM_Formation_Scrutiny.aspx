<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="EM.Master" CodeBehind="EM_Formation_Scrutiny.aspx.cs" Inherits="EstateConveyance.EM_Formation_Scrutiny" %>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#scrutiny" role="tab" aria-controls="parigatecha"
                          aria-selected="true">Scrutiny Summary & Remarks</a>
                      </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h6>Telephone No.  :  0217 391054</h6>
                            ...
                            <hr />  <br /> <br />
                             <h4>Upload Scrutiny Documents</h4>
                    <div class="row"> 
                    <div class="col-md-6">
                        <br />
                        <h6>Upload Scrutiny Documents</h6>
                    </div>
                    </div>
                            <br />
                    <div class="row">
                    <div class="col-md-6">
                        <h6>1. Recent receipt of service charge paid</h6>
                    </div>
                        <div class="col-md-6">
                        <button class="btn btn-success" type="submit" style="width:200px;">Upload</button>
                    </div>

                </div><br />
                     <div class="row">
                    <div class="col-md-8">
                        <h6>2. Allotment letters are available for all house owners or not?</h6>
                    </div>
                        <div class="col-md-2">
                        <input type="radio" id="yes" value="yes"> &nbsp; <label>Yes</label>
                    </div>
                          <div class="col-md-2">
                        <input type="radio" id="no" value="no"> &nbsp; <label>No</label>
                    </div>
                     ...
                     <div class="row">
                    <div class="col-md-8">
                        <h6>3. Society has uploaded society resolution or not?</h6>
                    </div>
                        <div class="col-md-2">
                        <input type="radio" id="selectyes" value="yes"> &nbsp; <label>Yes</label>
                    </div>
                         <div class="col-md-2">
                        <input type="radio" id="selectno" value="no"> &nbsp; <label>No</label>
                    </div>

                </div>
                             <hr />  <br /> <br />

                            <h4>Generate No Dues Certificates</h4>
                    <div class="row"> 
                    <div class="col-md-12">
                        <br />
                        <h6>Generate No due Certificate, if all service chnages are by paid by the society</h6>
                    </div>
                        ...
                        <br />
                            <button class="btn btn-success" type="submit">Generate No Due Certificate</button>
