<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DyCO_DyCDO.Master" CodeBehind="DyCO_Formation_Application.aspx.cs" Inherits="EstateConveyance.DyCO_Formation_Application" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row card" style="width:100%; margin-left:10px; padding:15px; top: 1px; left: 0px;">
      <center> <h2 style="color:#ff8d00;">Application for Society Formation</h2><hr></center>
        <div class="form-row ">
          ...
          <tbody>
            ...
            <tr style="font-size:14px;">
              ...
              <td width ="25%">
                  ...
                  |<a href="DyCO_Formation_Scrutiny.aspx" style="color:blue"> Scrutiny & Remark</a> | <br /> 
                  |<a href="DyCO_Formation_Forward_Application.aspx" style="color:blue"> Forward Application</a> |   <br />
              </td>
            </tr>
