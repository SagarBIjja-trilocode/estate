<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/DyCO_DyCDO.Master" CodeBehind="DyCO_CheckList_Note.aspx.cs" Inherits="EstateConveyance.DyCO_CheckList_Note" %>
       ...
       <center> <h3 style="color:#ff8d00;">Checklist & Office Note</h3><hr></center>
        ...
        <input class="btn btn-success" type=button value="Go back" onclick='history.go(-1)' >
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#parigatecha" role="tab" aria-controls="parigatecha"
                          aria-selected="true">Add Checklist Scrutiny</a>
                      </li>
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <br />  
                            <h4>Add Checklist Scrutiny</h4> <hr />
